    ...
    return (
        <AnimatedStep>
            <div className="w-full h-full flex flex-col items-center px-4 animate-fade-in min-h-0">
                <div className="max-w-4xl w-full h-full min-h-0 flex flex-col justify-between pt-20 pb-12 md:pt-40 md:pb-24 md:[@media(max-height:1000px)]:pt-10 md:[@media(max-height:1000px)]:pb-8">
                    ...
                    <div
                        className="flex-grow min-h-0 overflow-y-auto no-scrollbar py-12 md:py-32 md:[@media(max-height:1000px)]:py-14 px-1 grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4 md:[@media(max-height:1000px)]:gap-2 items-stretch"
                        role="list"
